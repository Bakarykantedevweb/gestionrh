<div>
    ...
    <div class="page-header">
        <div class="row align-items-center">
            ...
            @if ($formationsListes && $FormationEnCour)
    ...
    <div class="card-body">
        ...
        <ul class="nav nav-tabs nav-tabs-solid nav-justified">
            <li class="nav-item"><a class="nav-link{{ $FormationEnCour ? ' active' : '' }}" href="#"
                    wire:click="activeContent('{{ encrypt('FormationEnCour') }}')">Formation en cours</a></li>
            <li class="nav-item"><a class="nav-link{{ $FormationTerminee ? ' active' : '' }}" href="#"
                    wire:click="activeContent('{{ encrypt('FormationTerminee') }}')">Formation Terminée</a></li>
        </ul>
    </div>
    @if ($formationsListes && $FormationEnCour)
        <div class="row">
                        ...
                        <tbody>
                            ...
                            @foreach ($formations as $formation)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ asset('uploads/admin/formation/fichier/'.$formation->fichier) }}"><span class="badge badge-success">Telecharger</span></a>
                                    </td>
                                    <td class="text-right">
    ...
    @endif
    @if ($formationsEdit && $FormationEnCour)
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
