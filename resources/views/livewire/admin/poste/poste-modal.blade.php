<!-- Add Poste Modal -->
<div wire:ignore.self id="add_poste" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form wire:submit.prevent="savePoste">
...
<!-- import Poste Modal -->
<div wire:ignore.self id="import_poste" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<!-- Edit Poste Modal -->
<div wire:ignore.self id="edit_poste" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form wire:submit.prevent="updatePoste">
                    <div class="form-group">
                        <label>Poste Nom <span class="text-danger">*</span></label>
                        <input class="form-control" wire:model="nom" type="text">
                        @error('nom')
...
<!-- Delete Poste Modal -->
<div wire:ignore.self id="delete_poste" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form wire:submit.prevent="destroyPoste">
