    ...
    <div class="card">
        <div class="card-body">
            ...
            <ul class="nav nav-tabs nav-tabs-solid nav-justified">
                <li class="nav-item"><a class="nav-link{{ $Offre ? ' active' : '' }}" href="#" wire:click="activeContent('{{ encrypt('Offre') }}')">Offres</a></li>
                <li class="nav-item"><a class="nav-link{{ $Offrehistorique ? ' active' : '' }}" href="#" wire:click="activeContent('{{ encrypt('Offrehistorique') }}')">Archives</a></li>
                            ...
                            <td class="text-right">
                                <div class="dropdown dropdown-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="{{ url('admin/offres/'.encrypt($offre->id).'/edit') }}" class="dropdown-item"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                ...
                <table class="table table-striped custom-table mb-0 datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $offre->nombre_place }}</td>
                            <td class="text-right">
                                <button wire:click="relancerOffre({{ $offre->id }})" data-toggle="modal" data-target="#relancer" class="btn btn-primary btn-sm" type="button">Relancer</button>
                            </td>
                        </tr>
                        @empty
                        <tr>
