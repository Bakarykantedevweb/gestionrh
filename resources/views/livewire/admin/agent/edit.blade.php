                    ...
                    <form wire:submit.prevent="UpdateEmploye">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="emp_formation" class="pro-overview tab-pane fade show">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title">Formations <a href="javascript:void(0);"
                                                wire:click="removeSchool(0)" class="delete-icon"><i
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        wire:model="schools.{{ $index }}.cycle">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        wire:model="schools.{{ $index }}.diplome">
                                                </div>
                                            </div>

                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Année Universitaire <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="add-more">
                                                <button type="button" class="btn btn-primary btn-sm mb-3"
                                                    wire:click.prevent="addSchool"><i class="fa fa-plus-circle"></i>
                                                    Ajouter</button>
                                            </div>
                                            @endif
                                        </div>
