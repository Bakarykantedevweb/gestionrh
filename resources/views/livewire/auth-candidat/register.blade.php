                    ...
                    <div class="login-register">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="candidate" role="tabpanel">
                                <form wire:submit.prevent="saveCandidat" class="mt-4">
                                    <div class="row g-2">
                                        ...
                                        <div class="mb-2 col-sm-6">
                                            <label class="form-label" for="password2">Confirmez le mot de passe <span
                                                    class="text-danger">*</span></label>
                                            <input type="password" wire:model="password_confirm" class="form-control" id="password2">
                                        </div>
                                        <div class="mb-3 col-12 mt-3">
                                            <div class="custom-control form-check">
                                                ...
                                                <label class="custom-control-label form-check-label"
                                                    for="accepts-02">Vous
                                                    acceptez nos Conditions générales d'utilisation et notre Politique
                                                    de
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md-6 text-md-end mt-2 text-center">
                                            <a href="{{ url('login-candidat') }}">Vous avez déjà un compte ?</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
