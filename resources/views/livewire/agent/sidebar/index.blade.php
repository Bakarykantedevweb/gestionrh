        ...
        <div class="main-sidebar">
            <div
                ...
                <div class="flex pt-4">
                    <a href="{{ route('agent-dashboard') }}">
                        <img class="size-11 transition-transform duration-500 ease-in-out hover:rotate-[360deg]"
                            src="{{ asset('agent/images/app-logo.png') }}" alt="logo">
                    </a>
                </div>
                ...
                <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
                    <!-- Dashobards -->
                    <a href="{{ route('agent-dashboard') }}"
                        class="flex size-11 items-center justify-center rounded-lg {{ request()->routeIs('agent-dashboard') ? 'bg-primary/10' : '' }} text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90"
                        x-tooltip.placement.right="'Tableau de Bord'">
                    ...
                    <!-- Apps -->
                    <a href="{{ url('agent/bulletins') }}"
                        class="flex size-11 items-center justify-center rounded-lg {{ request()->routeIs('agent.bulletin') ? 'bg-primary/10' : '' }} outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                        x-tooltip.placement.right="'Bulletins'">
                    ...
                    <!-- Pages And Layouts -->
                    <a href="{{ url('agent/conges') }}"
                        class="flex size-11 items-center justify-center rounded-lg {{ request()->routeIs('congeAgent.index') ? 'bg-primary/10' : '' }} outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                        x-tooltip.placement.right="'Conges'">
                        <svg class="h-7 w-7" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <!-- Forms -->
                    <a href="{{ url('agent/performance') }}"
                        class="flex size-11 items-center justify-center rounded-lg {{ request()->routeIs('performanceAgent.index') ? 'bg-primary/10' : '' }} outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                        x-tooltip.placement.right="'Performance'">
                        <svg class="h-7 w-7" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Components -->
                    <a href="{{ url('agent/formations') }}"
                        class="flex size-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                        x-tooltip.placement.right="'Formation'">
                        <svg class="h-7 w-7" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-opacity="0.5"
                ...
                <div class="flex flex-col items-center space-y-3 py-3">
                    ...
                    <div x-data="usePopper({ placement: 'right-end', offset: 12 })" @click.outside="isShowPopper && (isShowPopper = false)"
                        ...
                        <button @click="isShowPopper = !isShowPopper" x-ref="popperRef" class="avatar size-12">
                            <img class="rounded-full" src="{{ asset('agent/images/avatar/avatar-12.jpg') }}"
                                alt="avatar">
                            <span
                                ...
                                <div
                                    ...
                                    <div class="avatar size-14">
                                        <img class="rounded-full"
                                            src="{{ asset('uploads/admin/agent/'.Auth::guard('webagent')->user()->photo) }}" alt="avatar">
                                    </div>
                                    <div>
                                        <a href="#"
                                        ...
                                        <p class="text-xs text-slate-400 dark:text-navy-300">
                                            {{ Auth::guard('webagent')->user()->poste->nom }}
                                        </p>
                                    </div>
                                </div>
            ...
            <div class="flex h-full grow flex-col bg-white pl-[var(--main-sidebar-width)] dark:bg-navy-750">
                ...
                <div x-data="{ expandedItem: null }" class="h-[calc(100%-4.5rem)] overflow-x-hidden pb-6"
                    ...
                    <ul class="flex flex-1 flex-col px-4 font-inter">
                        <li>
                            <a x-data="navLink" href="{{ route('agent-dashboard') }}"
                        ...
                        <li>
                            <a x-data="navLink" href="{{ url('agent/profile') }}"
                                :class="isActive ? 'font-medium text-primary dark:text-accent-light' :
                                    'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'"
                                class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out">
                                Profile
                    ...
                    <ul class="flex flex-1 flex-col px-4 font-inter">
                        <li>
                            <a x-data="navLink" href="{{ url('agent/bulletins') }}"
                                :class="isActive ? 'font-medium text-primary dark:text-accent-light' :
                                    'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'"
                                class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out">
                                Bulletins
                        ...
                        <li>
                            <a x-data="navLink" href="{{ url('agent/conges') }}"
                                :class="isActive ? 'font-medium text-primary dark:text-accent-light' :
                                    'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'"
                                class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out">
                                Conge
                        ...
                        <li>
                            <a x-data="navLink" href="{{ url('agent/performance') }}"
                                :class="isActive ? 'font-medium text-primary dark:text-accent-light' :
                                    'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'"
                                class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out">
                                Performance
                        ...
                        <li>
                            <a x-data="navLink" href="{{ url('agent/formations') }}"
                                :class="isActive ? 'font-medium text-primary dark:text-accent-light' :
                                    'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'"
                                class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out">
                                Formation
                        ...
                        <div class="my-3 mx-4 h-px bg-slate-200 dark:bg-navy-500"></div>
                        <li>
                            <a x-data="navLink" href="{{ route('agent-logout') }}"
                                :class="isActive ? 'font-medium text-primary dark:text-accent-light' :
                                    'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'"
                                class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out">
                                Deconnexion
